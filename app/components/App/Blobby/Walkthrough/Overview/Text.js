        ...
        return (
            <section>
                <p>I noticed that, whenever I start a new React project,
                    ...
                    <p>Redux (<Link to="/walkthrough/redux">see related section</Link>) is implementent with classes instead of
                    ...
                    for Axios in order to make actions (<Link to="/walkthrough/actions">see related section</Link>)
                    more clean and avoid code duplicates.</p>

                   <p>Check-out <Link to="/walkthrough/getting-started">Getting Started</Link> section in order to start using
